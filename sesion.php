...
<center>
     ...
     <table width="900px" heigth="60px" align="center">
      ...
      <br>
          ...
          <form method="post" action="pagBD/sesionBD.php" autocomplete="off">
          <table width="800px">
          <tr><td height="40px" align="center">Digite nombre del usuario y contraseñas:</td></tr>
          <tr><td height="40px" align="center"><input class="input" type="text" placeholder="Usuario" name="usuario" id="usuario"/></td></tr>
          <tr><td align="center"><input class="input" type="password" placeholder="Contraseña" name="contrasenia" id="contrasenia"/></td></tr>
          <tr><td height="100px" align="center"><button class="btn1" type="Submit">Iniciar Sesion</button></td></tr>
          </table>
          </form>
     </div>
     <div class="info">
